...
Esta sección es, en su gran mayoría, un transcrito de lo expuesto en \cite{biberstein} lo cuál también se puede encontrar en \url{https://delta.cs.cinvestav.mx/~gmorales/Biberstein/fvd/node19.html}.
...
\begin{enumerate}[label=\arabic*.]
	...
	\item Sea $R$ un anillo conmutativo con identidad y $A \in \Mnc{3}{R}$ con
	$$A = \begin{bmatrix}
		0 & a & b \\
		-a & 0 & c \\
		-b & -c & 0
