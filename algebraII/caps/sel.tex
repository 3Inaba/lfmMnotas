...
\iffalse
	...
	\item Resolver y encontrar la matriz inversa del sistema de ecuaciones lineales con coeficientes en $(\gconmodr{\lp}{\equiv}, \oplus, \land)$ donde $\varphi, \psi$ y $\zeta$ son fórmulas atómicas de $\lp$ lógicamente independientes entre sí
