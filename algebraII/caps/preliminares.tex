...
\begin{axiom}[de Especificación/Esquema de Comprensión]
	Si $\varphi$ es una fórmula de la teoría ZFE, diremos que $\varphi$ es una propiedad y denotaremos $\varphi(x)$ si la propiedad se evalúa como verdadera en $x$. Entonces para cada propiedad $\varphi$ y conjunto $x$, el término clase $\{y \mid y \in x \land \varphi(y)\}$ que denotamos $\{y \in x \mid \varphi(y) \}$ es un conjunto.
\end{axiom}
