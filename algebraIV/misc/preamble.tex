...
%---------------------------------------------------------------
\newcommand{\cond}{%
	\mathbin{\raisebox{0pt}{\makebox[1.0em]{%
...
\renewcommand{\implies}{%
	\mathbin{\raisebox{0pt}{\makebox[1.0em]{%
			...
			\begin{picture}(-0.1,0.1)
				\polygon*(0.5,0.9)(0.5,0.1)(1,0.5)
				\polygon*(0.5,0.560)(0.5,0.540)(-1.25,0.540)(-1.25,0.560)
				\polygon*(0.5,0.360)(0.5,0.340)(-1.25,0.340)(-1.25,0.360)
			\end{picture}%
	}}}%
}
\newcommand{\bicond}{%
...
\newcommand{\lp}{\mathcal{L}_{0}}
\newcommand{\form}{\mathrm{Frm}}
\newcommand{\flpo}{\form(\lpo)}
\newcommand{\flp}{\form(\lp)}
...
\newtheorem{col}{Corolary}[chapter]
\newtheorem{lema}{Lemma}[chapter]
\newtheorem{ejem}{Example}[chapter]
...
{.5em}{ }
\theoremstyle{mteo}
\newtheorem{mprop}{Proposition}[chapter]
